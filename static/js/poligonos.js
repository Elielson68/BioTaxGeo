...
//Função que cria os inputs para cada vértice criada
...
function Modificando_vertice_marker(){
...
function Plotar_novo_poligono(){
  if(poligono_criado["poligono"+(poligono_selecionado+1)].length > 2){
    //faz uma breve verificação pra desativar os botões que já foram clicados
